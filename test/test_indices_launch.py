...
class TestIndicesNode(unittest.TestCase):
    def test_indices_publish(self):
        rclpy.init()
        node = rclpy.create_node('indices_launch_test')
        try:
            ...
            node.create_subscription(Image, 'indices/gli', _callback, qos_profile)
            ...
            out = received['msg']
            self.assertEqual(out.encoding, '32FC1')
