...
- try `pixel_format: H264` vs `MJPG` in the params file
- reduce resolution (e.g., 1280×720) in the params file to confirm the pipeline can sustain 30 Hz
...
- set `qos_best_effort: false` in the camera params file to publish RELIABLE.
